define([ "dojo/_base/declare", 
         ...
         "dojo/text!./templates/calendarMonthColumn.html" ,
         "dijit/form/DateTextBox",
         "dijit/form/Form",
         "dijit/form/DropDownButton"
		],
function(declare, lang, on, Calendar, MonthColumnView, VerticalRenderer, Mouse, Keyboard, template) {
	return declare("widgets.ExtendedCalendar", Calendar, {
				templateString : template,
				verticalRenderer : VerticalRenderer,
				_createDefaultViews : function() {
					this.inherited(arguments);
					// create the month column view.
					this.monthColumnView = declare([ MonthColumnView, Keyboard, Mouse ])({ verticalRenderer : VerticalRenderer });
